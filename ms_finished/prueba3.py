...
df= pd.read_csv('/Users/estefhanymorenovega/Market_Scanner/sip.csv')
df['id'] = df['Symbol']
...
app.layout = html.Div(style={'backgroundColor': colors['background']}, children=[
    ...
    html.H4(children='Stocks in Play',style={
        'color': colors['text2']} 
    ), 

    html.Div(children= 'Most active tickers pre-market and its information', style={
        'color': colors['text2']}
    ),
    ...
    html.H4(children='Candlesticks Chart',style={
        'color': colors['text2']} 
    ),

    html.Div(children= 'Live price evolution, Volume, Moving Avarage and Bollinger Bands', style={
        'color': colors['text2']}
    ),
    ...
    html.Div(children= 'Technical Analysis and Recommendations', style={
        'color': colors['text2']}
    ),
    dcc.Markdown(children= '''**SMA**: calculates the average of a selected range of prices, by the number of periods in that range. 
        It can aid in determining if an asset price will continue or if it will reverse a bull or bear trend.''',
        style={
        'color': colors['text2']}
    ),
     dcc.Markdown(children= '''**Stoch**: is a momentum oscillator. The premise of stochastics is that when a stock trends upwards,
      its closing price tends to trade at the high end of the day's range or price action. ''',
        style={
        'color': colors['text2']}
    ),
    dcc.Markdown(children= '''**RSI**:The relative strength index (RSI) is a momentum indicator that measures the magnitude of recent price changes
